...
Original file is located at
    https://colab.research.google.com/drive/1yB4G5PS8zRdmMbXfWYmN8fCPHxxsQFFN
"""
...
try:
    ...
    st.error("The 'reportlab' library is not installed. Please install it using 'pip install reportlab'.")
    st.stop()
...
def export_query_logs_to_pdf(student_email=None):
    try:
        ...
        # Create PDF in memory with robust error handling
        buffer = io.BytesIO()
        try:
        ...
        st.error("Database error while fetching query logs.")
        return None
    except Exception as e:
        logger.error(f"Unexpected error in export_query_logs_to_pdf: {str(e)}")
